...
public class FrameTest extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
		Weather w = new Weather(jTextField1.getText());
		String s = "Weather Status is : ";
		s += "\n";
		JSONObject jsWeather = new JSONObject(w.getCurrent());
		s += "Situation : ";
		s += jsWeather.getJSONArray("weather").getJSONObject(0).get("main");
		s += "\n";
		s += "Temperature : ";
		s += jsWeather.getJSONObject("main").get("temp");
		s += "\n";
		s += "Visibility : ";
		s += jsWeather.get("visibility");
		s += "\n";
		s += "Cloud Percent : ";
		s += jsWeather.getJSONObject("clouds").get("all");
